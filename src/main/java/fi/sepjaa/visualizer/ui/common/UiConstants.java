...
public class UiConstants {
	...
	public static final int PREFERRED_CANVAS_WIDTH = 600;
	public static final int PREFERRED_CANVAS_HEIGHT = 400;
	public static final int FPS = 144;

	public static final String TITLE = "Algorithm Visualizer";
	...
	public static final String PATHFINDING_TITLE = "Pathfinding";
